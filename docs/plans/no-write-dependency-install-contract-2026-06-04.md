...
- Prior plan pattern: `docs/plans/durable-admission-workflow-design-2026-06-03.md:52-70` defines a dry-run contract that names future copy/install intent while keeping mutation flags false; `docs/plans/durable-admission-workflow-design-2026-06-03.md:92-105` requires future install/copy slices to add explicit command contract, dry-run mode, immutable source evidence, staged destination evidence, collision policy, separate permission approval, and tests proving historical evidence is not rewritten.
- Managed-prefix boundary precedent: `docs/plans/human-approved-durable-write-mode-2026-06-04.md:31` confines true mutation flags to managed-prefix/profile writes, while durable skills, registry, ledgers, run logs, permission widening, stable routing, and governor steering remain false. `docs/plans/human-approved-durable-write-mode-2026-06-04.md:50-55` explicitly excludes dependency installation.
...
- `docs/plans/durable-admission-workflow-design-2026-06-03.md:52-105`
- `docs/plans/human-approved-durable-write-mode-2026-06-04.md:31`, `docs/plans/human-approved-durable-write-mode-2026-06-04.md:50-55`
