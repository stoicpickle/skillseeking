...
- Human write-gate verification through `skill-agent shadow-write-gate`, proving prepared acceptance evidence, restored rollback pointer, supplied exact acceptance digest, and unchanged source hash before any real managed-prefix write mode exists.
