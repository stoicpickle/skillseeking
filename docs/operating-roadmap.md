...
2. **Human promotion workflow design**
   ...
   - Next coverage: candidate-to-stable workflow design, promotion review queues, durable `skills/` admission, and stable routing after the managed-prefix boundary and no-write dependency evidence boundary remain proven. Dependency evidence is not dependency installation, candidate-to-stable promotion, durable `skills/` admission, registry mutation, ledger mutation, stable routing, or governor steering.
