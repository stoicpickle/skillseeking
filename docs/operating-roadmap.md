...
2. **Human promotion workflow design**
   ...
   - Next coverage: no-write dependency install contract, candidate-to-stable workflow design, promotion review queues, durable `skills/` admission, and stable routing after the managed-prefix boundary remains proven.
