# Skill-Seeking Agent Codex Notes

- Ground roadmap, review, and differentiation work in the current repo, `skill-agent` CLI, build map, and run evidence.
- Prefer lifecycle evidence, candidate-ledger proof, and capability-gap evaluation over adding autonomous behavior too early.
